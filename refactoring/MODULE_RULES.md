...
Конфиги источника MUST лежать в `configs/sources/<source>/<source>.yaml`.

Схема конфигов MUST быть явно описана и валидирована при запуске; несовместимые ключи — ошибка.
