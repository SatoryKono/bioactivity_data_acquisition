...
from infrastructure.http.api_client import (
    CircuitBreaker,
...
class TestUnifiedAPIClient:
    ...
    @patch("infrastructure.http.api_client.requests.Session")
    ...
    def test_compute_backoff(self) -> None:
        ...
        from infrastructure.http.api_client import _RetryState  # type: ignore[reportPrivateUsage]
