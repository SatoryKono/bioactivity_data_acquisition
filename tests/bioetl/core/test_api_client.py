...
from bioetl.infrastructure.http.api_client import (
    CircuitBreaker,
...
class TestUnifiedAPIClient:
    ...
    @patch("bioetl.infrastructure.http.api_client.requests.Session")
    ...
    def test_compute_backoff(self) -> None:
        ...
        from bioetl.infrastructure.http.api_client import _RetryState  # type: ignore[reportPrivateUsage]
