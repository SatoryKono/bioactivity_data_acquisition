"""Test pagination strategies for ChEMBL entity factory."""
...
class _StaticPagination(PaginationStrategy):
    """Static pagination strategy for testing with predefined extra page."""
    ...
    def iter_pages(
        ...
        *,
        ...
        """Yield extra page after initial response."""
...
def test_entity_factory_passes_explicit_strategy_instance() -> None:
    """Test that explicit pagination strategy instance is passed correctly."""
...
def test_factory_with_next_link_strategy_follows_links() -> None:
    """Test that factory with next link strategy follows pagination links."""
    transport = _ScriptedTransport(
        [
