...
class TestPipelineBase:
    ...
    def test_plan_run_artifacts(self, pipeline_config_fixture, run_id: str):
        ...
        assert artifacts.write.metadata.name == "activity_chembl_20240101_meta.yaml"
    ...
    def test_list_run_stems(self, pipeline_config_fixture, run_id: str, tmp_output_dir: Path):
        ...
        meta_file1 = pipeline_dir / "activity_chembl_20240101_meta.yaml"
        meta_file2 = pipeline_dir / "activity_chembl_20240102_meta.yaml"
        meta_file1.touch()
        meta_file2.touch()
    ...
    def test_apply_retention_policy(self, pipeline_config_fixture, run_id: str):
        ...
        pipeline_dir = pipeline.pipeline_directory
        for i in range(5):
            meta_file = pipeline_dir / f"activity_chembl_run{i}_meta.yaml"
        ...
        remaining_meta = list(pipeline_dir.glob("activity_chembl_*_meta.yaml"))
    ...
    def test_run_with_mode(self, pipeline_config_fixture, run_id: str):
        ...
        assert result.write_result.dataset.name == f"activity_chembl_full_{run_id}.csv"
