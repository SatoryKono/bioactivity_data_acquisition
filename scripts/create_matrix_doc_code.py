...
def create_matrix() -> List[Dict[str, Any]]:
    ...
    activity_contracts = [
        ...
        {
            "doc_point": "Config: configs/pipelines/chembl/activity_chembl.yaml",
            "code_file": "configs/pipelines/chembl/activity_chembl.yaml",
            "code_symbol": "activity_chembl.yaml",
            "pipeline": "activity",
            "contract": "обязательный",
            "status": "ok",
            "action": "verify",
    ...
    assay_contracts = [
        ...
        {
            "doc_point": "Config: configs/pipelines/chembl/assay_chembl.yaml",
            "code_file": "configs/pipelines/chembl/assay_chembl.yaml",
            "code_symbol": "assay_chembl.yaml",
            "pipeline": "assay",
            "contract": "обязательный",
            "status": "ok",
            "action": "verify",
    ...
    testitem_contracts = [
        ...
        {
            "doc_point": "Config: configs/pipelines/chembl/testitem_chembl.yaml",
            "code_file": "configs/pipelines/chembl/testitem_chembl.yaml",
            "code_symbol": "testitem_chembl.yaml",
            "pipeline": "testitem",
            "contract": "обязательный",
            "status": "ok",
            "action": "verify",
