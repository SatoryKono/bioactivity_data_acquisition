#!/usr/bin/env python3
"""Аудит документации bioactivity_data_acquisition."""
...
def main() -> None:
    ...
    with UnifiedLogger.stage("write_artifacts"):
        ...
        _write_csv_atomic(results_dir / "GAPS_TABLE.csv", fieldnames, gaps_rows)
        ...
        _write_markdown_atomic(results_dir / "LINKCHECK.md", markdown_lines)
        log.info("artifacts_written", directory=str(results_dir))
