...
class AssayRawSchema(pa.DataFrameModel):
    ...
    description: Series[str] = pa.Field(description="Assay description", nullable=True)
    assay_format: Series[str] = pa.Field(description="Assay format", nullable=True)
...
class AssayNormalizedSchema(pa.DataFrameModel):
    ...
    chembl_release: Series[str] = pa.Field(description="ChEMBL release version", nullable=False)
    ...
    src_id: Series[object] = pa.Field(description="Source identifier", nullable=True)
    src_name: Series[str] = pa.Field(description="Source name", nullable=True)
    src_assay_id: Series[str] = pa.Field(description="Source assay identifier", nullable=True)
    ...
    bao_format: Series[str] = pa.Field(description="BAO format", nullable=True)
    bao_label: Series[str] = pa.Field(description="BAO label", nullable=True)
    assay_category: Series[object] = pa.Field(description="Assay category (list)", nullable=True)
    assay_classifications: Series[object] = pa.Field(description="Assay classifications (list)", nullable=True)
    ...
    # Description and protocol fields
    description: Series[str] = pa.Field(description="Assay description", nullable=True)
    assay_parameters: Series[object] = pa.Field(description="Assay parameters (dict/str)", nullable=True)
    assay_format: Series[str] = pa.Field(description="Assay format", nullable=True)
