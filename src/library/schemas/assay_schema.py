...
class AssayRawSchema(pa.DataFrameModel):
    ...
    assay_class_id: Series[object] = pa.Field(description="Assay class identifier", nullable=True)
    ...
    variant_id: Series[object] = pa.Field(description="Variant identifier", nullable=True)
...
class AssayNormalizedSchema(pa.DataFrameModel):
    ...
    assay_parameters: Series[str] = pa.Field(
        description="Assay parameters",
        nullable=True
    )
    assay_parameters_json: Series[str] = pa.Field(
        description="Assay parameters (JSON)",
        nullable=True
    )
