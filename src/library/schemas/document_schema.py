        ...
        return DataFrameSchema(
            {
                ...
                "doi": Column(
                    ...
                    metadata={"normalization_functions": ["normalize_string_strip", "normalize_string_lower", "normalize_doi"]},
                ),
                "pmid": Column(
                    pa.String,
                    checks=[
                    ...
                    metadata={"normalization_functions": ["normalize_string_strip", "normalize_pmid"]},
                ),
                "title": Column(
                    pa.String,
                    checks=[
        ...
        return DataFrameSchema(
            {
                ...
                "document_sortorder": Column(
                    pa.Int,
                    checks=[Check.greater_than_or_equal_to(0, error="Sort order must be >= 0"), Check(lambda x: x.notna())],
                    nullable=False,
...
# result = validate_entity_data("document", df, ValidationStage.NORMALIZED)
