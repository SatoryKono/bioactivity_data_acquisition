...
class GracefulShutdownManager:
    ...
    def wait_for_shutdown(self, timeout: float | None = None) -> bool:
        ...
        # track thread object for potential debugging
...
__all__ = ["GracefulShutdownManager", "get_shutdown_manager", "register_shutdown_handler", "is_shutdown_requested", "request_shutdown", "ShutdownContext"]
