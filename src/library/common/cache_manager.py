...
class CacheManager:
    ...
    def set(self, cache_type: str, endpoint: str, params: dict[str, Any], data: dict[str, Any], ttl: int | None = None) -> None:
        """Cache data with TTL.
        ...
        cache_data = {"data": data, "expires_at": expires_at, "cached_at": time.time(), "endpoint": endpoint, "params": params}
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        for cache_type_dir in self.cache_dir.iterdir():
            if cache_type_dir.is_dir():
                ...
                stats["by_type"][type_name] = {"files": len(files), "size_bytes": type_size}
