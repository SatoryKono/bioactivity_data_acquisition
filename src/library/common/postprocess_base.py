...
register_postprocess_step("add_missing_document_fields", add_missing_document_fields_step)
register_postprocess_step("add_missing_testitem_fields", add_missing_testitem_fields_step)
