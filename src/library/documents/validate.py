...
class DocumentValidator:
        ...
        return DataFrameSchema(
            {
                ...
                "document_chembl_id": Column(
                    pa.String, checks=[Check.str_matches(r"^CHEMBL\d+$", name="chembl_id_format")], nullable=False, description="ChEMBL document identifier"
                ),
                "title": Column(pa.String, nullable=False, description="Document title"),
                # Optional fields
                "doi": Column(pa.String, nullable=True, checks=[Check.str_matches(r"^10\.\d+/.*", name="doi_format")], description="Digital Object Identifier"),
                "document_pubmed_id": Column(pa.String, nullable=True, checks=[Check.str_matches(r"^\d+$", name="pmid_format")], description="PubMed identifier"),
                "journal": Column(pa.String, nullable=True, description="Journal name"),
                "year": Column(
                    pa.Float64,
                    nullable=True,
                    checks=[Check.greater_than_or_equal_to(1900, name="year_min"), Check.less_than_or_equal_to(2030, name="year_max")],
                    description="Publication year",
                ),
                # Legacy fields (matching actual CSV columns)
                "abstract": Column(pa.String, nullable=True, description="Document abstract"),
                "pubmed_authors": Column(pa.String, nullable=True, description="Document authors from PubMed"),
                "document_classification": Column(pa.Float64, nullable=True, description="Document classification"),
                "referenses_on_previous_experiments": Column(pa.Boolean, nullable=True, description="Contains external links"),
                "first_page": Column(pa.Int64, nullable=True, checks=[Check.greater_than(0, name="page_positive")], description="First page number"),
                "original_experimental_document": Column(pa.Boolean, nullable=True, description="Is experimental document"),
                "issue": Column(pa.Float64, nullable=True, checks=[Check.greater_than(0, name="issue_positive")], description="Journal issue number"),
                "last_page": Column(pa.Float64, nullable=True, checks=[Check.greater_than(0, name="last_page_positive")], description="Last page number"),
                "month": Column(
                    pa.Int64,
                    nullable=True,
                    checks=[Check.greater_than_or_equal_to(1, name="month_min"), Check.less_than_or_equal_to(12, name="month_max")],
                    description="Publication month",
                ),
                "volume": Column(pa.Float64, nullable=True, checks=[Check.greater_than(0, name="volume_positive")], description="Journal volume"),
            }
        )
        ...
        return DataFrameSchema(
            {
                ...
                "title": Column(pa.String, nullable=False, description="Document title"),
                "doi": Column(pa.String, nullable=True, description="Digital Object Identifier"),
                "document_pubmed_id": Column(pa.String, nullable=True, description="PubMed identifier"),
                # Computed fields
                "publication_date": Column(
                    pa.String, nullable=True, checks=[Check.str_matches(r"^\d{4}-\d{2}-\d{2}$", name="date_format")], description="Normalized publication date"
                ),
                "document_sortorder": Column(pa.String, nullable=True, description="Document sort order"),
                "citation": Column(pa.String, nullable=True, description="Formatted citation"),
    ...
    def validate_normalized(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # Only include fields that are NOT already defined in get_raw_schema() and get_normalized_schema()
        all_columns = {
            # Fields NOT in other schemas
            ...
            "crossref_pmid": Column(pa.String, nullable=True, required=False),
            "crossref_abstract": Column(pa.String, nullable=True, required=False),
            "crossref_issn": Column(pa.String, nullable=True, required=False),
            "crossref_authors": Column(pa.String, nullable=True, required=False),
            "crossref_journal": Column(pa.String, nullable=True, required=False),
            "crossref_year": Column(pa.Int, nullable=True, required=False),
            "crossref_volume": Column(pa.String, nullable=True, required=False),
            "crossref_issue": Column(pa.String, nullable=True, required=False),
            "crossref_first_page": Column(pa.String, nullable=True, required=False),
            "crossref_last_page": Column(pa.String, nullable=True, required=False),
            
            # NEW: Additional OpenAlex fields
            "openalex_doc_type": Column(pa.String, nullable=True, required=False),
            "openalex_crossref_doc_type": Column(pa.String, nullable=True, required=False),
            "openalex_year": Column(pa.Int, nullable=True, required=False),
            "openalex_pmid": Column(pa.String, nullable=True, required=False),
            "openalex_abstract": Column(pa.String, nullable=True, required=False),
            "openalex_issn": Column(pa.String, nullable=True, required=False),
            "openalex_authors": Column(pa.String, nullable=True, required=False),
            "openalex_journal": Column(pa.String, nullable=True, required=False),
            "openalex_volume": Column(pa.String, nullable=True, required=False),
            "openalex_issue": Column(pa.String, nullable=True, required=False),
            "openalex_first_page": Column(pa.String, nullable=True, required=False),
            "openalex_last_page": Column(pa.String, nullable=True, required=False),
            
            # NEW: CHEMBL.DOCS.* fields
            "CHEMBL.DOCS.document_chembl_id": Column(pa.String, nullable=True, required=False),
            "CHEMBL.DOCS.doc_type": Column(pa.String, nullable=True, required=False),
            "CHEMBL.DOCS.title": Column(pa.String, nullable=True, required=False),
            "CHEMBL.DOCS.journal": Column(pa.String, nullable=True, required=False),
            "CHEMBL.DOCS.year": Column(pa.Int, nullable=True, required=False),
            "CHEMBL.DOCS.volume": Column(pa.String, nullable=True, required=False),
            "CHEMBL.DOCS.issue": Column(pa.String, nullable=True, required=False),
            "CHEMBL.DOCS.first_page": Column(pa.String, nullable=True, required=False),
            "CHEMBL.DOCS.last_page": Column(pa.String, nullable=True, required=False),
            "CHEMBL.DOCS.doi": Column(pa.String, nullable=True, required=False),
            "CHEMBL.DOCS.pubmed_id": Column(pa.String, nullable=True, required=False),
            "CHEMBL.DOCS.abstract": Column(pa.String, nullable=True, required=False),
            "CHEMBL.DOCS.chembl_release": Column(pa.String, nullable=True, required=False),
            
            # NEW: CHEMBL.SOURCE.* fields
            "CHEMBL.SOURCE.src_id": Column(pa.Int, nullable=True, required=False),
            "CHEMBL.SOURCE.src_description": Column(pa.String, nullable=True, required=False),
            "CHEMBL.SOURCE.src_short_name": Column(pa.String, nullable=True, required=False),
            "CHEMBL.SOURCE.src_url": Column(pa.String, nullable=True, required=False),
            "CHEMBL.SOURCE.data": Column(pa.String, nullable=True, required=False),
            
            # NEW: Tracking and metadata fields
            "chembl_error": Column(pa.String, nullable=True, required=False),
            "chembl_release": Column(pa.String, nullable=True, required=False),
            "pipeline_version": Column(pa.String, nullable=True, required=False),
            "extracted_at": Column(pa.String, nullable=True, required=False),
            "hash_business_key": Column(pa.String, nullable=True, required=False),
            "hash_row": Column(pa.String, nullable=True, required=False),
        }
    ...
    def validate_business_rules(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        if "year" in validated_df.columns:
            invalid_year_mask = validated_df["year"].notna() & ((validated_df["year"] < 1900) | (validated_df["year"] > 2030))
        ...
        if "month" in validated_df.columns:
            invalid_month_mask = validated_df["month"].notna() & ((validated_df["month"] < 1) | (validated_df["month"] > 12))
        ...
        if "first_page" in validated_df.columns and "last_page" in validated_df.columns:
            page_logic_errors = validated_df["first_page"].notna() & validated_df["last_page"].notna() & (validated_df["first_page"] > validated_df["last_page"])
        ...
        if "publication_date" in validated_df.columns and "year" in validated_df.columns:
            date_year_mismatch = (
                validated_df["publication_date"].notna() & validated_df["year"].notna() & ~validated_df["publication_date"].str.startswith(validated_df["year"].astype(str))
            )
