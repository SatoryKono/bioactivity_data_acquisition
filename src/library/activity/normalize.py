...
class ActivityNormalizer:
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        ...
        self.relation_mapping = self.config.get("normalization", {}).get(
            "relation_mapping",
            {
                "=": {"lower_bound": "standard_value", "upper_bound": "standard_value", "is_censored": False},
                ">=": {"lower_bound": "standard_value", "upper_bound": None, "is_censored": True},
                ">": {"lower_bound": "standard_value", "upper_bound": None, "is_censored": True},
                "<=": {"lower_bound": None, "upper_bound": "standard_value", "is_censored": True},
                "<": {"lower_bound": None, "upper_bound": "standard_value", "is_censored": True},
            },
        )
...
>>>>>>> Stashed changes
        ...
        good_quality = ~critical_missing & ~validity_issues & ~activity_issues & df["standard_relation"].isin(self.relation_mapping.keys())
        if good_quality.any():
...
>>>>>>> Stashed changes
        if non_censored_mask.any():
            ...
            bounds_mismatch = (non_censored_df["lower_bound"] != non_censored_df["standard_value"]) | (non_censored_df["upper_bound"] != non_censored_df["standard_value"])
...
=======
    ...
    def _add_metadata_fields(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        chembl_client = create_api_client("chembl", self.config, "activity")
    ...
    def _normalize_text_fields(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        text_fields = [
            ...
            "standard_text_value",
            "activity_prop_type",
            "activity_prop_standard_type",
            "activity_prop_text_value",
            "activity_prop_standard_text_value",
            "activity_prop_comments",
            "action_type",
        ]
