...
def check_chembl_limits():
    ...
    try:
        ...
        console.print(f"[red]Ошибка при проверке ChEMBL: {e}[/red]")
...
def check_pubmed_limits():
    ...
    try:
        ...
        console.print(f"[red]Ошибка при проверке PubMed: {e}[/red]")
...
def check_crossref_limits():
    ...
    try:
        ...
        console.print(f"[red]Ошибка при проверке Crossref: {e}[/red]")
...
def check_openalex_limits():
    ...
    try:
        ...
        console.print(f"[red]Ошибка при проверке OpenAlex: {e}[/red]")
...
def check_semantic_scholar_limits():
    ...
    try:
        ...
        console.print(f"[red]Ошибка при проверке Semantic Scholar: {e}[/red]")
...
"""
    ...
    console.print(Panel(recommendations, title="Рекомендации", border_style="green"))


def main():
    """Основная функция."""
    console.print("[bold blue]Детальная проверка лимитов API[/bold blue]\n")
