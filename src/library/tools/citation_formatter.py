...
def _format_pages(first_page: Any, last_page: Any) -> str:
    ...
    if last_page_int != first_page_int and last_page_int <= 10000 and last_page_int > first_page_int:
...
def add_citation_column(df: pd.DataFrame, column_mapping: dict[str, str] | None = None) -> pd.DataFrame:
    ...
    default_mapping = {"journal": "journal", "year": "year", "volume": "volume", "issue": "issue", "first_page": "first_page", "last_page": "last_page"}
