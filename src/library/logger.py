...
def configure_logging(level: int = logging.INFO) -> None:
    ...
    warnings.warn("library.logger.configure_logging is deprecated. Use library.logging_setup.configure_logging instead.", DeprecationWarning, stacklevel=2)
...
def get_logger(name: str, **initial_values: Any) -> Any:
    ...
    warnings.warn("library.logger.get_logger is deprecated. Use library.logging_setup.get_logger instead.", DeprecationWarning, stacklevel=2)
