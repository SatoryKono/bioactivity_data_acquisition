...
class TestItemSchema(FallbackMetadataMixin, BaseSchema):
    ...
    therapeutic_flag: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Therapeutic flag")
    ...
    dosed_ingredient: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Dosed ingredient flag")
    ...
    direct_interaction: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Direct interaction flag")
    molecular_mechanism: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Molecular mechanism flag")
    oral: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Oral administration flag")
    parenteral: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Parenteral administration flag")
    topical: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Topical administration flag")
    black_box_warning: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Black box warning flag")
    natural_product: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Natural product flag")
    first_in_class: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="First-in-class flag")
    prodrug: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Prodrug flag")
    inorganic_flag: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Inorganic flag")
    polymer_flag: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Polymer flag")
    ...
    withdrawn_flag: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Withdrawn flag")
    ...
    drug_substance_flag: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Drug substance flag")
    drug_indication_flag: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Drug indication flag")
    drug_antibacterial_flag: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Drug antibacterial flag")
    drug_antiviral_flag: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Drug antiviral flag")
    drug_antifungal_flag: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Drug antifungal flag")
    drug_antiparasitic_flag: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Drug antiparasitic flag")
    drug_antineoplastic_flag: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Drug antineoplastic flag")
    drug_immunosuppressant_flag: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Drug immunosuppressant flag")
    drug_antiinflammatory_flag: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Drug anti-inflammatory flag")
    ...
    ro3_pass: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Rule of three pass flag")
    ...
    lipinski_ro5_pass: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="Lipinski RO5 pass flag")
    ...
    pubchem_fallback_used: Series[pd.BooleanDtype] = pa.Field(nullable=True, description="PubChem fallback used flag")
