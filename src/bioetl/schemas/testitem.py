...
class TestItemSchema(BaseSchema):
    ...
    hba: Series[pd.Int64Dtype] = pa.Field(nullable=True, coerce=False, ge=0, description="Hydrogen bond acceptors")
    hbd: Series[pd.Int64Dtype] = pa.Field(nullable=True, coerce=False, ge=0, description="Hydrogen bond donors")
    psa: Series[float] = pa.Field(nullable=True, ge=0, description="Polar surface area")
    rtb: Series[pd.Int64Dtype] = pa.Field(nullable=True, coerce=False, ge=0, description="Rotatable bonds (rtb)")
