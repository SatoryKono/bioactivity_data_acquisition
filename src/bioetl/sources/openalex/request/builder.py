"""Request builder for the OpenAlex Works API."""
...
class OpenAlexRequestBuilder(BaseRequestBuilder):
    """Prepare OpenAlex requests with deterministic ordering and headers."""

    DEFAULT_USER_AGENT = "bioetl-openalex-client/1.0"
