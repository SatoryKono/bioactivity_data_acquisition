"""Target-specific HTTP client helpers built on top of :mod:`bioetl.clients.client_chembl_common`."""
...
class ChemblTargetClient(ChemblEntityIteratorBase):
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize the target client wrapper.
