...
class OpenalexResourceConfig:
    """
    Конфиг ресурса OPENALEX.
...
class OpenalexWorkClient(DataClient):
    source = "openalex"
    ...
    def __init__(
        ...
        self._resource_config = OpenalexResourceConfig(
    ...
    def __enter__(self) -> "OpenalexWorkClient":
        return self
...
__all__ = ["OpenalexWorkClient", "OpenalexResourceConfig"]
