...
def build_quality_report(
    ...
    *,
    ...
    def _builder(metrics_bundle: QCMetricsBundle) -> pd.DataFrame:
...
def build_correlation_report(
    ...
    *,
    ...
    def _builder(metrics_bundle: QCMetricsBundle) -> pd.DataFrame | None:
...
def build_qc_metrics_payload(
    ...
    *,
    ...
    def _builder(metrics_bundle: QCMetricsBundle) -> Mapping[str, Any]:
...
def _build_qc_artifact(
    builder: Callable[[QCMetricsBundle], T],
