...
PIPELINE_REGISTRY: tuple[PipelineCommandSpec, ...] = (
    PipelineCommandSpec(
        ...
        pipeline_path="application.pipelines.specs.chembl.activity.run.ChemblActivityPipeline",
        default_config="configs/pipelines/activity/activity_chembl.yaml",
    ),
    PipelineCommandSpec(
        code="assay_chembl",
        description="Extract assay records from ChEMBL API.",
        pipeline_path="application.pipelines.specs.chembl.assay.run.ChemblAssayPipeline",
    ...
    PipelineCommandSpec(
        ...
        pipeline_path="application.pipelines.specs.chembl.testitem.run.TestItemChemblPipeline",
    ...
    PipelineCommandSpec(
        ...
        pipeline_path="application.pipelines.specs.chembl.target.run.ChemblTargetPipeline",
    ...
    PipelineCommandSpec(
        ...
        pipeline_path="application.pipelines.specs.chembl.document.run.ChemblDocumentPipeline",
