...
_CLI_APP_MODULE = "interfaces.cli.cli_app"

if TYPE_CHECKING:
    from interfaces.cli.cli_app import app as app  # type: ignore[attr-defined]
    from interfaces.cli.cli_app import create_app as create_app
    from interfaces.cli.cli_app import run as run
