...
Console entry points (``python -m interfaces.cli.cli_app`` и установленные
...
точкой входа для CLI после удаления ``interfaces.cli.main``.
"""
...
from interfaces.cli.cli_entrypoint import TyperApp, run_app
from interfaces.cli.cli_entrypoint import create_app as create_typer_app
from interfaces.cli.cli_registry import (
    COMMAND_REGISTRY,
    PIPELINE_REGISTRY,
    CommandConfig,
    PipelineCommandSpec,
)
from interfaces.cli.run_chembl_all import run_chembl_all_command
from infrastructure.config.runtime import Config as RuntimeConfig
from infrastructure.logging import LogEvents, UnifiedLogger
from infrastructure.runtime import cli_feedback
