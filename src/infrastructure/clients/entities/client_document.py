"""Document-specific HTTP client helpers built on top of :mod:`infrastructure.clients.client_chembl`."""
...
class ChemblDocumentClient(ChemblEntityConfigMixin, ChemblEntityFetcherBase):
