...
from infrastructure.schemas.common_schema import resolve_row_hash_fields
...
DocumentSchema = create_schema(
    columns={
        ...
        "abstract": CF.string(),
        "doi_clean": CF.doi(),
        "pubmed_id": CF.int64(ge=1, pandas_nullable=True),
        "year": CF.int64(ge=1500, le=2100, pandas_nullable=True),
        "volume": CF.string(),
        "issue": CF.string(),
        "first_page": CF.string(),
        "last_page": CF.string(),
        "authors": CF.string(),
        "authors_count": CF.int64(ge=0, pandas_nullable=True),
