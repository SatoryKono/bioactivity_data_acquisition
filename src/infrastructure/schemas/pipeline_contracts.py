...
from infrastructure.schemas import SchemaRegistryEntry, get_schema
...
_PIPELINE_SCHEMA_CONTRACTS: Mapping[str, PipelineSchemaContract] = {
    ...
    "chembl_assay": PipelineSchemaContract(
        ...
        schema_out="infrastructure.schemas.chembl_assay_schema.AssaySchema",
    ),
    ...
    "document_chembl": PipelineSchemaContract(
        ...
        schema_out="infrastructure.schemas.chembl_document_schema.DocumentSchema",
    ),
    "target_chembl": PipelineSchemaContract(
        pipeline_code="target_chembl",
        schema_out="infrastructure.schemas.chembl_target_schema.TargetSchema",
    ),
    "testitem_chembl": PipelineSchemaContract(
        pipeline_code="testitem_chembl",
        schema_out="infrastructure.schemas.chembl_testitem_schema.TestItemSchema",
    ),
}
