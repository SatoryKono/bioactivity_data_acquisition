...
from infrastructure.schema.vocabulary_bindings import SchemaVocabularyBinding
...
_register_builtin_schema(
    identifier="infrastructure.schemas.chembl_activity_schema.ActivitySchema",
    module_path="infrastructure.schemas.chembl_activity_schema",
    schema_attr="ActivitySchema",
    version_attr="SCHEMA_VERSION",
    column_order_attr="COLUMN_ORDER",
)
_register_builtin_schema(
    identifier="infrastructure.schemas.chembl_testitem_schema.TestItemSchema",
    module_path="infrastructure.schemas.chembl_testitem_schema",
    schema_attr="TestItemSchema",
    version_attr="SCHEMA_VERSION",
    column_order_attr="COLUMN_ORDER",
)
_register_builtin_schema(
    identifier="infrastructure.schemas.chembl_assay_schema.AssaySchema",
    module_path="infrastructure.schemas.chembl_assay_schema",
    schema_attr="AssaySchema",
    version_attr="SCHEMA_VERSION",
    column_order_attr="COLUMN_ORDER",
)
_register_builtin_schema(
    identifier="infrastructure.schemas.chembl_document_schema.DocumentSchema",
    module_path="infrastructure.schemas.chembl_document_schema",
    schema_attr="DocumentSchema",
    version_attr="SCHEMA_VERSION",
    column_order_attr="COLUMN_ORDER",
)
_register_builtin_schema(
    identifier="infrastructure.schemas.chembl_target_schema.TargetSchema",
    module_path="infrastructure.schemas.chembl_target_schema",
    schema_attr="TargetSchema",
    version_attr="SCHEMA_VERSION",
    column_order_attr="COLUMN_ORDER",
)
_register_builtin_schema(
    identifier="infrastructure.schemas.chembl_metadata_schema.LoadMetaSchema",
    module_path="infrastructure.schemas.chembl_metadata_schema",
