...
from pipelines.assays_chembl import AssaysChemblPipeline
from pipelines.documents_chembl import DocumentsChemblPipeline
from pipelines.targets_chembl import TargetsChemblPipeline
from pipelines.testitems_chembl import TestItemsChemblPipeline
