...
from infrastructure.chembl.normalize import add_row_metadata
...
from application.pipelines.specs.chembl._constants import API_ACTIVITY_FIELDS
...
from infrastructure.schemas.chembl_activity_schema import ACTIVITY_PROPERTY_KEYS
...
class ChemblActivityPipeline(BaseChemblPipeline):
    ...
    def __init__(
        ...
        *,
        ...
        from infrastructure.config.models.http import (
            HTTPClientConfig,
            HTTPConfig,
            RetryConfig,
        )
        from infrastructure.config.models.infrastructure import (
        ...
        if config is not None:
            ...
            from infrastructure.config.models.io import IOConfig
            ...
            from infrastructure.config.models.domain import PipelineDomainConfig
            from infrastructure.config.models.fallbacks import FallbacksConfig
    ...
    def _normalize_measurements(
        ...
        from infrastructure.schemas._validators import RELATIONS
