<!-- SUMMARY: Правила для memory системы, краткая справка. Полные документы см. в _docs/styleguide/ -->
# Правила для Memory (из политик)

> **Примечание**: Это краткая справка для memory системы. Полные документы см.:
...
## DOC-001: Именование документации
...
## ABC-001: Политика создания ABC/Default/Impl
...
## NAMING-001: Именование сущностей
...
## DOCSYNC-001: Стандарты документации
