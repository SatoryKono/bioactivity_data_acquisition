...
- **[Naming Normalization Plan](styleguide/12-naming-normalization-plan.md)**: Текущий план устранения нарушений, чек-листы по директориям и регламент обновления инструментов контроля.
