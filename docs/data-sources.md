...
Проект интегрируется с множественными внешними API для получения биоактивностных данных. Каждый источник имеет свои лимиты, политики и особенности использования.

## Поддерживаемые источники

### ChEMBL

**Описание:** Основная база данных биоактивностных данных  
**URL:** <https://www.ebi.ac.uk/chembl/api/data>  
**Тип данных:** Молекулы, мишени, эксперименты, активности, документы

**Лимиты:**

- RPS: ≤5 запросов в секунду
- Бюджет: ≤100,000 запросов в день
- TTL кэша: 1 день

**Особенности:**

- Основной источник данных
- Требует соблюдения лимитов
- Поддерживает пагинацию
- Автоматические ретраи при ошибках

### UniProt

**Описание:** База данных белковых последовательностей и функциональной аннотации  
**URL:** <https://rest.uniprot.org>  
**Тип данных:** Информация о белках, мишенях
