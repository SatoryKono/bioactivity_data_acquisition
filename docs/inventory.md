...
Данный документ содержит полную инвентаризацию всех файлов в директории `docs/` с классификацией по статусу и планами действий.
...
- **В навигации**: 15
- **Не в навигации**: 40
- **Битые ссылки**: 12+ файлов
- **Дубли**: 4 пары
- **Кандидаты на удаление**: 5 файлов/папок
