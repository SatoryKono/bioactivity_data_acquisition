...
| `1`       | `pydantic.ValidationError`                                                                              | Config model validation `[ref: repo:src/bioetl/config/models/base.py]`              | YAML parsed successfully but violated the typed configuration contract (e.g., wrong field types).              |
