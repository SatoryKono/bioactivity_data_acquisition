...
2.  **Five-Stage Pipeline Lifecycle**: Each pipeline follows a strict, sequential lifecycle composed of five distinct stages:
    ...
    - **`run`**: Orchestrates the execution of the stages, handling logging, timing, and error management.
