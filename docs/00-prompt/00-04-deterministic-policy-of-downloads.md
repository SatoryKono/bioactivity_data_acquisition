...
[ref: repo:tests/bioetl/@refactoring_001] ← golden-тесты и проверки стабильности вывода
...
Golden-проверки
Опиши стратегию тестов: стабилизация вывода в tests/bioetl/golden/<pipeline>/, сравнение контента с допуском только для технических полей времени, верификация meta.yaml, проверка стабильного порядка колонок и равенства хэшей между запусками при одинаковых входах и профилях.
