...
Назначение CLI и область применения. Ссылка на каркас стадий пайплайна (extract → transform → validate → write, оркестрируемых методом run()) из README. Укажи, что CLI — фронт к PipelineBase и к конфиг-моделям. GitHub
