...
Роль стека «клиент → пагинация → парсер → нормализатор → схема» в каркасе PipelineBase и интеграция с CLI. Укажи, что пайплайны объявлены в README и исполняются через python -m bioetl.cli.app <pipeline>.
GitHub
...
ChEMBL Activity bioetl.cli.app activity    [ref: repo:src/bioetl/...@refactoring_001]  page/size или cursor    [ref: repo:src/bioetl/...@refactoring_001]  [ref: repo:src/bioetl/...@refactoring_001]  [ref: repo:src/bioetl/...@refactoring_001]  перечисли поля  стабильные поля классы/статусы  [ref: repo:tests/bioetl/...@refactoring_001]
ChEMBL Assay    …   …   …   …   …   …   …   …   …   …
ChEMBL Target   …   …   …   …   …   …   …   …   …   …
ChEMBL Document …   …   …   …   …   …   …   …   …   …
ChEMBL TestItem …   …   …   …   …   …   …   …   …   …
...
В 01-interface-matrix.md перечислить все поддерживаемые пайплайны, как указано в README (Activity, Assay, Target, Document, TestItem), с их CLI-командами и путями к конфигам.
GitHub
