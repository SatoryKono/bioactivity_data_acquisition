...
1. **[CLEANUP_REPORT.md](../../archive/CLEANUP_REPORT.md)** - основной отчёт об очистке и валидации
...
- Ведите историю изменений в [CLEANUP_REPORT.md](../../archive/CLEANUP_REPORT.md)
...
- [CLEANUP_REPORT.md](../../archive/CLEANUP_REPORT.md) - основной отчёт об очистке
