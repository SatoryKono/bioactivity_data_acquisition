...
- CLEANUP_REPORT.md - основной отчёт об очистке (архивный документ)
- Makefile - доступные команды валидации
- Pre-commit конфигурация - настройки хуков
- MkDocs конфигурация - настройки документации
