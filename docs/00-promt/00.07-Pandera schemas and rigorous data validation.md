...
[ref: repo:docs/requirements/00-architecture-overview.md@test_refactoring_32]

[ref: repo:docs/pipelines/PIPELINES.md@test_refactoring_32]

[ref: repo:src/bioetl/pipelines/base.py@test_refactoring_32]

[ref: repo:src/bioetl/configs/models.py@test_refactoring_32]

[ref: repo:docs/qc/QA_QC.md@test_refactoring_32]

[ref: repo:tests/@test_refactoring_32]
...
Все пути в формате [ref: repo:...@test_refactoring_32].
...
[ref: repo:docs/configs/CONFIGS.md@test_refactoring_32]
...
Внутренние ссылки только в формате [ref: repo:<path>@test_refactoring_32].
