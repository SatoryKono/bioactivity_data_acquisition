...
- **SRC-01 (MUST).** Для каждой сущности должен быть зафиксирован перечень источников (основной и дополнительные) с указанием, какие поля покрываются каждым источником. Все обязательные поля сущности покрыты хотя бы одним источником; «дыры покрытия» отсутствуют. Проверка: сквозная валидация покрытия по карте «поле → источник» и перечню обязательных полей (отчёт о непросуммированных полях пуст). Источники: [ref: repo:docs/ @test_refactoring_32], [ref: repo:docs/requirements/03-data-extraction.md @test_refactoring_32].
...
- **LINK-01 (MUST).** `activities` ссылаются на существующие `assays`, `documents`, `testitems`, `targets` по каноническим ключам. Неразрешённых ссылок быть не должно. Проверка: внешние ключи и полнота джойнов. Источник: [ref: repo:docs/requirements/04-normalization-validation.md @test_refactoring_32].
...
| Требование | Ссылки |
| --- | --- |
| SRC-01 | [ref: repo:docs/ @test_refactoring_32]; [ref: repo:docs/requirements/03-data-extraction.md @test_refactoring_32] |
| SRC-02 | [ref: repo:docs/requirements/04-normalization-validation.md @test_refactoring_32]; [ref: repo:src/bioetl/schemas/ @test_refactoring_32] |
| SRC-03 | [ref: repo:docs/requirements/03-data-extraction.md @test_refactoring_32]; [ref: repo:docs/requirements/04-normalization-validation.md @test_refactoring_32] |
| SRC-04 | [ref: repo:docs/requirements/03-data-extraction.md @test_refactoring_32] |
| DATA-01 | [ref: repo:docs/requirements/05-assay-extraction.md @test_refactoring_32]; [ref: repo:docs/requirements/06-activity-data-extraction.md @test_refactoring_32]; [ref: repo:docs/requirements/07a-testitem-extraction.md @test_refactoring_32]; [ref: repo:docs/requirements/07b-testitem-data-extraction.md @test_refactoring_32]; [ref: repo:docs/requirements/08a-target-chembl-extraction.md @test_refactoring_32] |
| DATA-02 | [ref: repo:src/bioetl/schemas/ @test_refactoring_32]; [ref: repo:docs/requirements/06-activity-data-extraction.md @test_refactoring_32] |
| DATA-03 | [ref: repo:docs/requirements/04-normalization-validation.md @test_refactoring_32] |
| DATA-04 | [ref: repo:docs/requirements/03-data-extraction.md @test_refactoring_32]; [ref: repo:docs/requirements/04-normalization-validation.md @test_refactoring_32] |
| DATA-05 | [ref: repo:docs/requirements/05-assay-extraction.md @test_refactoring_32]; [ref: repo:docs/requirements/08a-target-chembl-extraction.md @test_refactoring_32] |
| DATA-06 | [ref: repo:docs/requirements/04-normalization-validation.md @test_refactoring_32] |
