...
- Deterministic hashing rules, float precision and column-order enforcement for final CSV/Parquet artefacts come from the determinism profile applied on top of pipeline configs.【F:configs/profiles/determinism.yaml†L2-L15】
