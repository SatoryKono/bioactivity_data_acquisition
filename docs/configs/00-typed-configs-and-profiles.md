...
3. **CLI Integration**: e2e-тест Typer-команды `bioetl.cli.app activity_chembl` c фиктивной конфигурацией, подтверждающий, что `cli.set_overrides` и `cli.profiles` заполняются из аргументов.
