...
- **LINK-01 (MUST).** `activities` ссылаются на существующие `assays`, `documents`, `testitems`, `targets` по каноническим ключам. Неразрешённых ссылок быть не должно. Проверка: внешние ключи и полнота джойнов. Источник: [ref: repo:docs/architecture/04-normalization-validation.md @test_refactoring_32].
- **LINK-02 (SHOULD).** Заданы кардинальности и уникальные бизнес-ключи: для `assays` уникален `assay_chembl_id`; для `documents` — `document_chembl_id`; для `activities` — комбинация (`assay_chembl_id`, `molecule_chembl_id`, `standard_type`, `relation`, дополнительные измерения при наличии). Нарушения уникальности отсутствуют; кардинальности не противоречат данным. Проверка: агрегаты уникальности. Источник: [ref: repo:src/bioetl/schemas/ @test_refactoring_32].
...
| Требование | Ссылки |
| --- | --- |
| SRC-01 | [ref: repo:docs/ @test_refactoring_32]; [ref: repo:docs/pipelines/03-data-extraction.md @test_refactoring_32] |
| SRC-02 | [ref: repo:docs/architecture/04-normalization-validation.md @test_refactoring_32]; [ref: repo:src/bioetl/schemas/ @test_refactoring_32] |
| SRC-03 | [ref: repo:docs/pipelines/03-data-extraction.md @test_refactoring_32]; [ref: repo:docs/architecture/04-normalization-validation.md @test_refactoring_32] |
| SRC-04 | [ref: repo:docs/pipelines/03-data-extraction.md @test_refactoring_32] |
| DATA-01 | [ref: repo:docs/pipelines/05-assay-extraction.md @test_refactoring_32]; [ref: repo:docs/pipelines/06-activity-data-extraction.md @test_refactoring_32]; [ref: repo:docs/pipelines/07a-testitem-extraction.md @test_refactoring_32]; [ref: repo:docs/pipelines/07b-testitem-data-extraction.md @test_refactoring_32]; [ref: repo:docs/pipelines/08-target-data-extraction.md @test_refactoring_32] |
| DATA-02 | [ref: repo:src/bioetl/schemas/ @test_refactoring_32]; [ref: repo:docs/pipelines/06-activity-data-extraction.md @test_refactoring_32] |
| DATA-03 | [ref: repo:docs/architecture/04-normalization-validation.md @test_refactoring_32] |
| DATA-04 | [ref: repo:docs/pipelines/03-data-extraction.md @test_refactoring_32]; [ref: repo:docs/architecture/04-normalization-validation.md @test_refactoring_32] |
| DATA-05 | [ref: repo:docs/pipelines/05-assay-extraction.md @test_refactoring_32]; [ref: repo:docs/pipelines/08-target-data-extraction.md @test_refactoring_32] |
| DATA-06 | [ref: repo:docs/architecture/04-normalization-validation.md @test_refactoring_32] |
| DATA-07 | [ref: repo:docs/pipelines/06-activity-data-extraction.md @test_refactoring_32]; [ref: repo:src/bioetl/schemas/ @test_refactoring_32] |
| LINK-01 | [ref: repo:docs/architecture/04-normalization-validation.md @test_refactoring_32] |
