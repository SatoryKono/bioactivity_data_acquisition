...
This document describes the structured logging format and mandatory fields for the Document (ChEMBL) pipeline.
...
- `actor`: Pipeline name (`document_chembl`)
