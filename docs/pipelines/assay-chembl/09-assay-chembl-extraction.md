...
**Расположение конфига:** `configs/pipelines/chembl/assay_chembl.yaml`
...
Полный пример конфигурационного файла для assay pipeline доступен в `configs/pipelines/chembl/assay_chembl.yaml`. Конфигурация включает все необходимые секции для работы пайплайна с детерминизмом, валидацией и обогащением данными.
