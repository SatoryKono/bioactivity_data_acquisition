...
pipeline, covering molecular structure normalization, identifier mapping, and
property standardization.

## Transformation Workflow

1. **Structure Normalization**: Standardizes InChI/SMILES representations
1. **Identifier Mapping**: Ensures consistent format for PubChem CID and related
   identifiers
1. **Property Normalization**: Standardizes molecular property values
