...
|----------|----------|--------|
| `--config PATH` | Путь к YAML-конфигурации пайплайна | `configs/pipelines/chembl/activity_chembl.yaml` |
...
```bash
# В configs/pipelines/chembl/activity_chembl.yaml:
sources:
  chembl:
    batch_size: 25
...
- `configs/pipelines/chembl/activity_chembl.yaml`
