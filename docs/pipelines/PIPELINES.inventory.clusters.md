...
- src/bioetl/transform/adapters/chembl_activity.py (source: activity)
...
- src/bioetl/pipelines/chembl_activity.py (source: activity)
...
- src/bioetl/transform/adapters/chembl_assay.py (source: assay)
...
- src/bioetl/pipelines/chembl_assay.py (source: assay)
...
- src/bioetl/sources/uniprot/normalizer_service.py (source: uniprot)
...
- tests/sources/chembl/test_parser.py (source: tests)
- tests/sources/chembl/test_pipeline_e2e.py (source: tests)
...
- tests/sources/document/test_normalizer.py (source: document)
- tests/sources/document/test_parser.py (source: document)
- tests/sources/document/test_pipeline_e2e.py (source: document)
- tests/sources/document/test_schema.py (source: document)
- tests/sources/iuphar/test_client.py (source: iuphar)
- tests/sources/iuphar/test_normalizer.py (source: iuphar)
- tests/sources/iuphar/test_parser.py (source: iuphar)
- tests/sources/iuphar/test_pipeline_e2e.py (source: iuphar)
- tests/sources/iuphar/test_schema.py (source: iuphar)
- tests/sources/openalex/__init__.py (source: tests)
- tests/sources/openalex/test_client.py (source: tests)
- tests/sources/openalex/test_merge.py (source: tests)
- tests/sources/openalex/test_normalizer.py (source: tests)
...
- tests/sources/pubchem/test_pipeline_e2e.py (source: pubchem)
...
- tests/sources/semantic_scholar/test_merge.py (source: tests)
- tests/sources/semantic_scholar/test_normalizer.py (source: tests)
- tests/sources/semantic_scholar/test_pagination.py (source: tests)
- tests/sources/semantic_scholar/test_parser.py (source: tests)
- tests/sources/semantic_scholar/test_pipeline_e2e.py (source: tests)
- tests/sources/semantic_scholar/test_schema.py (source: tests)
...
- tests/sources/uniprot/test_schema.py (source: uniprot)
- tests/test_fixtures_smoke.py (source: tests)
- tests/unit/config/test_pipeline_config.py (source: tests)
- tests/unit/core/test_api_client.py (source: tests)
- tests/unit/core/test_api_client_properties.py (source: tests)
