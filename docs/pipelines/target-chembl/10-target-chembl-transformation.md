...
This document describes the transformation stage of the Target (ChEMBL)
...
1. **Identifier Mapping**: Ensures consistent format for target and UniProt
   identifiers
1. **Enrichment**: Adds protein information via UniProt lookups
...
- [09-target-chembl-extraction.md](09-target-chembl-extraction.md) — Extraction
  stage
- [11-target-chembl-validation.md](11-target-chembl-validation.md) — Validation
  stage
