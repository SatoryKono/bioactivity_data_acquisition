...
This document describes the transformation stage of the TestItem (PubChem)
pipeline, covering molecule property normalization and structure data
processing.

## Transformation Overview

The transformation stage normalizes raw PubChem molecule data, processes
structure information (SMILES, InChI), and standardizes molecular properties.
